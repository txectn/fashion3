...
var Swiper = function() {
        ...
        updateSlides: function() {
            ...
            for (let a = 0; a < c; a += 1) {
                ...
                "none" !== y(i, "display"))) {
                    ...
                    h.push(L),
                    s.centeredSlides ? (S = S + L / 2 + M / 2 + x,
                    0 === M && 0 !== a && (S = S - E / 2 - x),
                    0 === a && (S = S - E / 2 - x),
                    Math.abs(S) < .001 && (S = 0),
                    s.roundLengths && (S = Math.floor(S)),
                    C % s.slidesPerGroup === 0 && p.push(S),
                    u.push(S)) : (s.roundLengths && (S = Math.floor(S)),
            ...
            if (e.virtualSize = Math.max(e.virtualSize, E) + v,
            ...
            !s.centeredSlides) {
                ...
                p = t,
                Math.floor(e.virtualSize - E) - Math.floor(p[p.length - 1]) > 1 && p.push(e.virtualSize - E)
            }
            if (l && s.loop) {
                const t = h[0] + x;
            ...
            if (c !== o && e.emit("slidesLengthChange"),
            p.length !== w && (e.params.watchOverflow && e.checkOverflow(),
    ...
    var q = {
        ...
        loopFix: function({slideRealIndex: e, slideTo: t=!0, direction: s, setTranslate: a, activeSlideIndex: i, initial: r, byController: n, byMousewheel: l}={}) {
            ...
            o.virtual && m.virtual.enabled)
                return t && (b || 0 !== o.snapIndex ? b && o.snapIndex < m.slidesPerView ? o.slideTo(o.virtual.slides.length + o.snapIndex, 0, !1, !0) : o.snapIndex === o.snapGrid.length - 1 && o.slideTo(o.virtual.slidesBefore, 0, !1, !0) : o.slideTo(o.virtual.slides.length, 0, !1, !0)),
                o.allowSlidePrev = c,
                o.allowSlideNext = p,
                void o.emit("loopFix");
            ...
            o.recalcSlides(),
            "auto" === m.slidesPerView ? o.updateSlides() : S && (T.length > 0 && z || M.length > 0 && I) && o.slides.forEach( (e, t) => {
            ...
            t)
                if (T.length > 0 && z) {
                    if (void 0 === e) {
                        ...
                        l ? o.setTranslate(o.translate - t) : (o.slideTo(L + Math.ceil(A), 0, !1, !0),
                    ...
                    if (void 0 === e) {
                        const e = o.slidesGrid[L]
                          , t = o.slidesGrid[L - $] - e;
                        l ? o.setTranslate(o.translate - t) : (o.slideTo(L - $, 0, !1, !0),
                        a && (o.touchEventsData.startTranslate = o.touchEventsData.startTranslate - t,
                        o.touchEventsData.currentTranslate = o.touchEventsData.currentTranslate - t))
                    } else {
    ...
    const ee = (e, t) => {
        ...
        i.updateOnWindowResize ? e[c](l.ios || l.android ? "resize orientationchange observerUpdate" : "resize observerUpdate", U, !0) : e[c]("observerUpdate", U, !0),
        r[d]("load", e.onLoad, {
            capture: !0
        }))
    }
    ...
    class ne {
        ...
        mount(e) {
            ...
            return !i && t.params.createElements && (i = w("div", t.params.wrapperClass),
            s.append(i),
    ...
    ne.use([function({swiper: e, on: t, emit: s}) {
        ...
        t("init", () => {
            ...
            i.observe(e.el)) : (a.addEventListener("resize", l),
    ...
    const be = [function({swiper: e, extendParams: t, on: s, emit: i}) {
        ...
        function d(t, s, a) {
            ...
            let E, x, S, T;
            if (E = e.rtlTranslate ? "right" : e.isHorizontal() ? "left" : "top",
            "auto" === l)
                if (m) {
                    let t = e.size;
                ...
                x = l;
            n ? (S = Math.floor(x / 2) + r + u,
            T = Math.floor(x / 2) + r + p) : (S = x + (r - 1) + u,
            T = (d ? x : r) + p);
            let M = y - T
              , C = y + S;
            d || (M = Math.max(M, 0),
            C = Math.min(C, v.length - 1));
            ...
            h === M && f === C && !t)
                return e.slidesGrid !== w && P !== b && e.slides.forEach(t => {
            ...
            const I = []
              ...
              , A = e => {
                let t = e;
                return e < 0 ? t = v.length + e : t >= v.length && (t -= v.length),
                t
            }
            ;
            if (t)
            ...
            for (let e = $; e < k; e += 1)
                if (e >= M && e <= C) {
                    const s = A(e);
                    void 0 === f || t ? z.push(s) : (e > f && z.push(s),
                    e < h && I.push(s))
                }
            if (z.forEach(t => {
        ...
        function o(t) {
            ...
            if (!(a.shiftKey || a.altKey || a.ctrlKey || a.metaKey || n.activeElement && (n.activeElement.isContentEditable || n.activeElement.nodeName && ("input" === n.activeElement.nodeName.toLowerCase() || "textarea" === n.activeElement.nodeName.toLowerCase())))) {
                if (e.params.keyboard.onlyInViewport && (d || c || p || u || m || h)) {
                    let t = !1;
                    if (x(e.el, `.${e.params.slideClass}, swiper-slide`).length > 0 && 0 === x(e.el, `.${e.params.slideActiveClass}`).length)
                        return;
                    const a = e.el
                      , i = a.clientWidth
                      , r = a.clientHeight
                ...
                ((d || p) && !s || (c || u) && s) && e.slidePrev()) : ((d || c || m || h) && (a.preventDefault ? a.preventDefault() : a.returnValue = !1),
                (c || h) && e.slideNext(),
                (d || m) && e.slidePrev()),
                i("keyPress", r)
            }
    ...
    , function({swiper: e, extendParams: t, on: s, emit: a}) {
        ...
        function f(t) {
            ...
            if (!e.mouseEntered && !u && !r.releaseOnEdges)
                return !0;
    ...
    , function({swiper: e, extendParams: t, on: s, emit: a}) {
        ...
        function c() {
            ...
            c.forEach( (t, r) => {
                ...
                "custom" === s.type && s.renderCustom ? (P(t, s.renderCustom(e, i + 1, u)),
        ...
        s("init", () => {
            !1 === e.params.pagination.enabled ? h() : (u(),
            p(),
            c())
        }
        ),
    ...
    , function({swiper: e, extendParams: t, on: s, emit: i}) {
        ...
        function f() {
            ...
            o = 0) : o + d > c && (l = c - o),
            e.isHorizontal() ? (a.style.transform = `translate3d(${o}px, 0, 0)`,
        ...
        function C() {
            ...
            if (!a.el)
                return;
            let i, l;
            if ("string" == typeof a.el && e.isElement && (i = e.el.querySelector(a.el)),
            i || "string" != typeof a.el)
                i || (i = a.el);
            else if (i = r.querySelectorAll(a.el),
            !i.length)
                return;
            ...
            i && (l = i.querySelector(de(e.params.scrollbar.dragClass)),
            l || (l = w("div", e.params.scrollbar.dragClass),
            i.append(l))),
            Object.assign(t, {
                el: i,
                dragEl: l
        ...
        s("init", () => {
            !1 === e.params.scrollbar.enabled ? L() : (C(),
            g(),
            f())
        }
        ),
    ...
    , function({swiper: e, extendParams: t, on: s, emit: a}) {
        ...
        function P(t) {
            ...
            m.length < 2 || (l = !0,
            h.scaleMove = E(),
            h.imageEl && (a.scale = h.scaleMove / h.scaleStart * o,
        ...
        function L(t) {
            ...
            n && l && (n = !1,
            l = !1,
            h.imageEl && (a.scale = Math.max(Math.min(a.scale, h.maxRatio), s.minRatio),
            h.imageEl.style.transitionDuration = `${e.params.speed}ms`,
            h.imageEl.style.transform = `translate3d(0,0,0) scale(${a.scale})`,
            o = a.scale,
            c = !1,
            a.scale > 1 && h.slideEl ? h.slideEl.classList.add(`${s.zoomedSlideClass}`) : a.scale <= 1 && h.slideEl && h.slideEl.classList.remove(`${s.zoomedSlideClass}`),
            1 === a.scale && (h.originX = 0,
            h.originY = 0,
            h.slideEl = void 0)))
        }
        function I() {
        ...
        function k(t) {
            ...
            m = f.currentY * s.scale / z) : (u = c * s.scale,
            m = p * s.scale),
            u < T && (u = T),
            u > C && (u = C),
            m < M && (m = M),
            m > P && (m = P)),
            A && 1 === s.scale && (h.originX = 0,
            h.originY = 0),
            f.currentX = u,
            f.currentY = m,
        ...
        function O() {
            ...
            h.originX = 0,
            h.originY = 0,
            e.params.zoom.panOnMouseMove && (u = {
                x: 0,
                y: 0
            },
            p && (p = !1,
    ...
    , function({swiper: e, extendParams: t, on: s}) {
        ...
        function g(t) {
            ...
            if (!e.pagination || !e.pagination.el || a !== e.pagination.el && !e.pagination.el.contains(t.target) || t.target.matches(de(e.params.pagination.bulletClass))) {
                if (e.navigation && e.navigation.prevEl && e.navigation.nextEl) {
                    ...
                    t.includes(a) && (e.isBeginning && !e.params.loop || e.slidePrev(),
        ...
        s("paginationUpdate", () => {
            e.params.a11y.enabled && function() {
                ...
                v() && e.pagination.bullets.forEach(s => {
                    ...
                    e.params.pagination.renderBullet || (p(s, "button"),
                    m(s, t.paginationBulletMessage.replace(/\{\{index\}\}/, E(s) + 1)))),
                    s.matches(de(e.params.pagination.bulletActiveClass)) ? s.setAttribute("aria-current", "true") : s.removeAttribute("aria-current")
                }
                )
            }()
        }
        ...
        s("destroy", () => {
            e.params.a11y.enabled && function() {
                ...
                e.el && "string" != typeof e.el && (e.el.removeEventListener("focus", C, !0),
    ...
    , function({swiper: e, extendParams: t, on: s, emit: i, params: r}) {
        ...
        const y = () => {
          ...
          , E = t => {
            ...
            !Number.isNaN(a) && a > 0 && void 0 === t && (s = a,
            g = a,
            v = a),
            o = s;
                    ...
                    if (t < -e.minTranslate())
                        ...
                        if (i.freeMode.momentum) {
                            ...
                            if (p < e.maxTranslate())
                                ...
                                u = e.maxTranslate(),
                                m = !0,
                                d.allowMomentumBounce = !0) : p = e.maxTranslate(),
                                i.loop && i.centeredSlides && (f = !0);
                            else if (p > e.minTranslate())
                                i.freeMode.momentumBounce ? (p - e.minTranslate() > h && (p = e.minTranslate() + h),
                                u = e.minTranslate(),
                                m = !0,
                                d.allowMomentumBounce = !0) : p = e.minTranslate(),
                                i.loop && i.centeredSlides && (f = !0);
                            ...
                            e.animating = !0,
                            S(r, () => {
                                e && !e.destroyed && d.allowMomentumBounce && (s("momentumBounce"),
                        ...
                        (!i.freeMode.momentum || c >= i.longSwipesMs) && (s("_freeModeStaticRelease"),
                        e.updateProgress(),
                        e.updateActiveIndex(),
                        e.updateSlidesClasses())
                    }
    ...
    , function({swiper: e, extendParams: t, on: s}) {
        ...
        s("update", () => {
            ...
            r = 1,
            e.emitContainerClasses()) : !n && a && (s.classList.add(`${t.containerModifierClass}grid`),
    ...
    , function({swiper: e, extendParams: t, on: s}) {
        ...
        const a = (e, t, s) => {
            ...
            e.append(a)),
            i || (i = w("div", ("swiper-slide-shadow-cube swiper-slide-shadow-" + (s ? "right" : "bottom")).split(" ")),
            e.append(i)),
        ...
        fe({
            ...
            setTranslate: () => {
                ...
                let h, f = 0;
                p.shadow && (u ? (h = e.wrapperEl.querySelector(".swiper-cube-shadow"),
                h || (h = w("div", "swiper-cube-shadow"),
                e.wrapperEl.append(h)),
                h.style.height = `${r}px`) : (h = t.querySelector(".swiper-cube-shadow"),
                h || (h = w("div", "swiper-cube-shadow"),
                t.append(h))));
                for (let e = 0; e < i.length; e += 1) {
                    const t = i[e];
